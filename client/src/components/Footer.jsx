...
import { BsFacebook , BsInstagram , BsTwitter , BsGithub , BsMeta , BsDribbble  } from 'react-icons/bs'
        ...
        <div className="w-full max-w-7xl mx-auto ">
          ...
          <Footer.Divider/>
            <div className="w-full sm:flex sm:items-center  sm:justify-between ">
                <Footer.Copyright href="#" by="Career Compass" year={new Date().getFullYear()}>
